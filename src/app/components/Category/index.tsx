...
const CategoryPage = async ({ id }: any) => {
  ...
  return (
    <>
      <Head>
        <title>
          {category ? `${category.name} - Hoạt Hình Trung Quốc` : "Đang tải..."}
        </title>
        <meta
          name="description"
          content={
            category ? `Xem các tập của ${category.name}` : "Đang tải..."
          }
        />
      </Head>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="w-full md:w-1/3">
            <div className="relative">
              <Image
                ...
                alt="Thiếu Niên Bạch Mã Túy Xuân Phong"
                width={300}
                height={450}
          ...
          <div className="w-full md:w-2/3">
            ...
            <div>
              ...
              <p className="text-gray-300">{category.des}</p>
