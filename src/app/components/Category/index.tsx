  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={c ? `Xem các tập của ${c.name}` : "Đang tải..."}
        />
      </Head>
      <div>
        {c && (
              ...
              <div className="md:flex lg:flex block gap-2">
                <div className="mb-5 lg:w-3/12 md:w-3/12 md:h-full h-52">
                  <MVImage
                    ...
                    alt={c.name}
                    title={c.name}
                    className="lg:h-[600px] md:h-[400] h-52"
                  />
                </div>
                <div className="lg:w-9/12 md:w-9/12">
                  ...
                  <div className="loai des text-[12px] md:text-[13px] lg:text-[14px]">
                    <b>{c.anotherName}</b>
                    <br />
                    <MVText style={{ color: "#999" }}>Tác giả :...</MVText>
                    <br />
                    <MVText style={{ color: "#999" }}>
                      Quốc gia : Chinese
                    </MVText>
                    <div>
                      <MVText style={{ color: "#999" }}>
                    ...
                    <div>
                      <MVText style={{ color: "#999" }}>{c.time + " "}</MVText>
                    </div>
                    <div>
                      <MVText style={{ color: "#999" }}>
