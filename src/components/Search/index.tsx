...
const SearchResults: React.FC<SearchResultsProps> = ({
  ...
  return (
    <div className="absolute top-[50px] left-0 right-0 max-h-[400px] scroll-container overflow-y-scroll lg:left-0 w-full flex flex-col bg-[#2f2f33] shadow-lg rounded-xl z-10 m-2">
